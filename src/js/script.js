                ...
                <div class="card rounded my-3 shadow-lg back-card imBlue_da_ba_dee_da_ba_daa">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <img src = "src/img/three-small-dots.png" alt ="logo afficher plus" onclick="showHide(`+index/2+`)" class="dots img-center">
                        </div>
...
function showHide(id, init) {
    console.log(id);
    console.log(document.getElementsByClassName("plusDeDetail")[id].style.display);

    if (display = document.getElementsByClassName("plusDeDetail")[id].style.display != 'flex'){
        display = document.getElementsByClassName("plusDeDetail")[id].style.display = 'flex';
    }else{
        display = document.getElementsByClassName("plusDeDetail")[id].style.display = 'none';
    }
}